                        ...
                        <div className="row">
                            <div className="col-sm-6 col-lg-4">
                                <div className="donation-item">
                                    ...
                                    <div className="inner">
                                        <div className="top">
                                            <a className="tags" href="#">#Agriculture et Environnement</a>
                                                <h3>
                            ...
                            <div className="col-sm-6 col-lg-4">
                                <div className="donation-item">
                                    ...
                                    <div className="inner">
                                        <div className="top">
                                            <a className="tags" href="#">#Elevage</a>
                                            <h3>
                                ...
                                <div className="donation-item">
                                    ...
                                    <div className="inner">
                                        <div className="top">
                                            ...
                                            <p>Participez au développement de cette entreprise occitane qui valorise les fruits et légumes déclassNameés locaux.</p>
                                        </div>
                                        <div className="bottom">
                                            <div className="skill">
                                                <div className="skill-bar skill1 wow fadeInLeftBig">
